...
const Color kDarkBlue = Color(0xFF1043B3);
const Color kWhite = Color(0xFFFFFFFF);
const Color kGrey = Color(0xFFF4F5F7);
const Color kBlack = Color(0xFF2D3243);

//color blue
const Color kComDarkBlue = Color(0xFF011F6D);
const Color kComBlue = Color(0xFF045497);
const Color kComLightBlue = Color(0xFF5189C6);
const Color kYellow = Color(0xFFFFAA4D);
